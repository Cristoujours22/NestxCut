...
getCompanySettings: () => ipcRenderer.invoke('get-company-settings'),
  ...
  // Inventory API
  getInventoryItems: (uid) => ipcRenderer.invoke('get-inventory-items', uid),
  ...
  getInventoryMovements: (uid) => ipcRenderer.invoke('get-inventory-movements', uid),
  ...
  getInventoryPurchases: (uid) => ipcRenderer.invoke('get-inventory-purchases', uid),
  ...
  // Door drafts API
  getDoorDrafts: () => ipcRenderer.invoke('get-door-drafts'),
  saveDoorDraft: (record) => ipcRenderer.invoke('save-door-draft', record),
  deleteDoorDraft: (id) => ipcRenderer.invoke('delete-door-draft', id),
