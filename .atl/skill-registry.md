...
- C:\Users\Cristian\.agents\skills
- C:\Users\Cristian\.config\opencode\skills
- C:\Users\Cristian\.claude\skills
- C:\Users\Cristian\.gemini\skills
- C:\Users\Cristian\.gemini\antigravity\skills
- C:\Users\Cristian\.cursor\skills
- C:\Users\Cristian\.copilot\skills
...
### adn-edicion-rapida
- Path: C:\Users\Cristian\.agents\skills\adn-edicion-rapida\SKILL.md
- Rules:
...
### branch-pr
- Path: C:\Users\Cristian\.config\opencode\skills\branch-pr\SKILL.md
...
### caveman
- Path: C:\Users\Cristian\.agents\skills\caveman\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### caveman-commit
- Path: C:\Users\Cristian\.agents\skills\caveman-commit\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### caveman-compress
- Path: C:\Users\Cristian\.agents\skills\caveman-compress\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### caveman-help
- Path: C:\Users\Cristian\.agents\skills\caveman-help\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### caveman-review
- Path: C:\Users\Cristian\.agents\skills\caveman-review\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### chained-pr
- Path: C:\Users\Cristian\.config\opencode\skills\chained-pr\SKILL.md
...
- Path: C:\Users\Cristian\.config\opencode\skills\cognitive-doc-design\SKILL.md
...
### comment-writer
- Path: C:\Users\Cristian\.config\opencode\skills\comment-writer\SKILL.md
...
### compress
- Path: C:\Users\Cristian\.agents\skills\compress\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### electron
- Path: C:\Users\Cristian\.agents\skills\electron\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### electron-menu
- Path: C:\Users\Cristian\.config\opencode\skills\electron-menu\SKILL.md
- Trigger: Trigger: /electromenu, menu electron, mostrar menu, ocultar menu. Toggle Electron menu bar on/off in the current Electron project.
- Rules:
  - NEVER rebuild — just edit the file and tell user to restart.
  - If file not found after checking 3 locations, STOP and ask user.
  - Always verify with grep after editing.
  - Do not delete `Menu` from require if other code uses it.

### find-skills
- Path: C:\Users\Cristian\.agents\skills\find-skills\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### go-testing
- Path: C:\Users\Cristian\.config\opencode\skills\go-testing\SKILL.md
...
### issue-creation
- Path: C:\Users\Cristian\.config\opencode\skills\issue-creation\SKILL.md
...
### judgment-day
- Path: C:\Users\Cristian\.config\opencode\skills\judgment-day\SKILL.md
...
- Path: C:\Users\Cristian\.agents\skills\nesting-optimization\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### openai-docs
- Path: C:\Users\Cristian\.codex\skills\.system\openai-docs\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### plugin-creator
- Path: C:\Users\Cristian\.codex\skills\.system\plugin-creator\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### skill-creator
- Path: C:\Users\Cristian\.config\opencode\skills\skill-creator\SKILL.md
...
### skill-improver
- Path: C:\Users\Cristian\.config\opencode\skills\skill-improver\SKILL.md
...
### skill-installer
- Path: C:\Users\Cristian\.codex\skills\.system\skill-installer\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### slides
- Path: C:\Users\Cristian\.codex\skills\codex-primary-runtime\slides\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### spreadsheets
- Path: C:\Users\Cristian\.codex\skills\codex-primary-runtime\spreadsheets\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### vercel-react-best-practices
- Path: C:\Users\Cristian\.agents\skills\vercel-react-best-practices\SKILL.md
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### work-unit-commits
- Path: C:\Users\Cristian\.config\opencode\skills\work-unit-commits\SKILL.md
